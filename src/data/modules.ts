...
export const matrixExamples = [
  { label: "Eindeutig 2x2", matrix: "2,1; 1,3", vector: "1; 2", note: "zwei Geraden mit Schnittpunkt" },
  { label: "Eindeutig 3x3", matrix: "2,1,-1; -3,-1,2; -2,1,2", vector: "8; -11; -3", note: "klassisches Gauß-Beispiel" },
  { label: "Unendlich viele", matrix: "1,2; 2,4", vector: "3; 6", note: "abhängige Gleichungen" },
  { label: "Keine Lösung", matrix: "1,2; 2,4", vector: "3; 7", note: "inkonsistentes System" },
  { label: "Singulär", matrix: "1,2; 2,4", vector: "3; 6", note: "keine inverse Matrix" },
  { label: "Diagonal", matrix: "3,0,0; 0,2,0; 0,0,-1", vector: "3; 4; -2", note: "Rang, Spur und Determinante klar" },
  { label: "Rotation", matrix: "0,-1; 1,0", vector: "1; 1", note: "orthogonale 2D-Abbildung" }
];
